      ...
      <html>
        ...
        <body>
          ...
          ${
            ...
            <div class="stats">
              <div class="stat-item">
                ...
                <div class="value">${totalBuses}</div>
              </div>
              <div class="stat-item">
                <div class="label">Active</div>
                <div class="value">${activeBuses}</div>
              </div>
              <div class="stat-item">
                <div class="label">Maintenance Needed</div>
                <div class="value">${maintenanceBuses}</div>
              </div>
            </div>
          `
              : currentTab === 'driver'
          ...
          `
            ...
            <div class="stats">
              <div class="stat-item">
                ...
                <div class="value">${totalConductors}</div>
              </div>
              <div class="stat-item">
                <div class="label">Active</div>
                <div class="value">${activeConductors}</div>
              </div>
            </div>
          `
          }
          ...
          <div class="footer">
            ...
            <p>Company: ${props.userData.company_id}</p>
          </div>
        </body>
      </html>
    `);
